    ...
    public partial class first : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, null, 50.00m, new DateTime(2023, 10, 6, 15, 47, 4, 723, DateTimeKind.Local).AddTicks(7878), "Transformers" });

            migrationBuilder.InsertData(
                table: "Movies",
                columns: new[] { "Id", "CompanyId", "Image", "Price", "ReleaseDate", "Title" },
                values: new object[] { 2, 2, null, 55.00m, new DateTime(2025, 10, 6, 15, 47, 4, 723, DateTimeKind.Local).AddTicks(7910), "Transformers 2" });
